  ...
  return (
    <div className="min-h-screen bg-[#f9fafb] text-gray-800 py-20 px-6">
      <div className="w-4/5 mx-auto">
        <h1 className="text-4xl font-bold mb-6 text-center text-orange-500">Terms and Conditions</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-[#fffaf3] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Acknowledgment</h2>
          ...
          <div className="bg-[#f2fcf4] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Links to Other Websites</h2>
          ...
          <div className="bg-[#fff2f2] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Termination</h2>
          ...
          <div className="bg-[#eef6ff] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Limitation of Liability</h2>
          ...
          <div className="bg-[#fffaf3] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          ...
          <div className="bg-[#f2fcf4] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Governing Law</h2>
          ...
          <div className="bg-[#fff2f2] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Disputes Resolution</h2>
          ...
          <div className="bg-[#eef6ff] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">For European Union (EU) Users</h2>
          ...
          <div className="bg-[#fffaf3] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">United States Legal Compliance</h2>
          ...
          <div className="bg-[#f2fcf4] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Severability and Waiver</h2>
          ...
          <div className="bg-[#fff2f2] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Translation Interpretation</h2>
          ...
          <div className="bg-[#eef6ff] rounded-2xl p-8 shadow-sm mb-8">
            <h2 className="text-3xl font-semibold mb-6 text-gray-800">Changes to These Terms and Conditions</h2>
