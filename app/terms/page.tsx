    ...
    <div className="min-h-screen bg-white text-black py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Acknowledgment</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Links to Other Websites</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Termination</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Governing Law</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Disputes Resolution</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">For European Union (EU) Users</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">United States Legal Compliance</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Severability and Waiver</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Translation Interpretation</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Changes to These Terms and Conditions</h2>
