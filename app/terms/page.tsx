  ...
  return (
    <div className="min-h-screen bg-[#f9fafb] text-gray-800 py-10 px-4 md:py-20 md:px-6">
      <div className="w-full md:w-4/5 mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center text-orange-500">Terms and Conditions</h1>
        <p className="text-sm text-gray-600 mb-8 text-center">Last updated: October 21, 2025</p>

        <div className="prose prose-lg max-w-none">
          

          <div className="bg-[#eef6ff] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800 flex items-center gap-3">
          ...
          <div className="bg-[#fffaf3] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Acknowledgment</h2>
          ...
          <div className="bg-[#f2fcf4] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Links to Other Websites</h2>
          ...
          <div className="bg-[#fff2f2] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Termination</h2>
          ...
          <div className="bg-[#eef6ff] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Limitation of Liability</h2>
          ...
          <div className="bg-[#fffaf3] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          ...
          <div className="bg-[#f2fcf4] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Governing Law</h2>
          ...
          <div className="bg-[#fff2f2] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Disputes Resolution</h2>
          ...
          <div className="bg-[#eef6ff] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">For European Union (EU) Users</h2>
          ...
          <div className="bg-[#fffaf3] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">United States Legal Compliance</h2>
          ...
          <div className="bg-[#f2fcf4] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Severability and Waiver</h2>
          <h3 className="text-2xl font-semibold mt-8 mb-4">Severability</h3>
          ...
          <h3 className="text-2xl font-semibold mt-8 mb-4">Waiver</h3>
          <p className="mb-4">Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>

          </div>

          <div className="bg-[#fff2f2] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Translation Interpretation</h2>
          <p className="mb-4">These Terms and Conditions may have been translated if We have made them available to You on our Service.</p>
          <p className="mb-6">You agree that the original English text shall prevail in the case of a dispute.</p>

          </div>

          <div className="bg-[#eef6ff] rounded-2xl p-6 md:p-8 shadow-sm mb-8">
            <h2 className="text-2xl md:text-3xl font-semibold mb-6 text-gray-800">Changes to These Terms and Conditions</h2>
