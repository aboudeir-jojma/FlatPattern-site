export default function PrivacyPage() {
 ...
 <div className="bg-[#fffaf3] rounded-2xl p-8 shadow-sm mb-8">
          ...
          <p className="mb-4">We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies We use include beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:</p>
          <ul className="list-disc pl-6 mb-6 space-y-2">
...
<div className="bg-[#fff2f2] rounded-2xl p-8 shadow-sm mb-8">
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Children's Privacy</h2>
          ...
          <h2 className="text-3xl font-semibold mt-12 mb-6">Changes to this Privacy Policy</h2>
